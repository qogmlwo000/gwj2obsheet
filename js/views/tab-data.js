...
const COLUMNS = {
  ...
  perm: [
    { key: "kucode",   label: "쿠코드",   type: "text", width: "92px" },
    { key: "name",     label: "성함",     type: "text", width: "100px" },
    { key: "team",     label: "조",       type: "text", width: "52px" },
    { key: "packable", label: "팩가능자", type: "multi", options: ["메뉴얼", "오토백"], width: "104px" },
    { key: "hiSkill",  label: "하이스킬", type: "multi", options: ["메뉴얼팩", "오토백", "집품", "워터"], width: "150px" },
    { key: "special",  label: "특수",     type: "multi", options: ["오더피커", "AGV", "워터", "메뉴얼 멀티", "오토백 멀티"], width: "182px" },
  ...
  temp: [
    ...
    { key: "packable", label: "팩가능자", type: "multi", options: ["메뉴얼", "오토백"], width: "104px" },
    { key: "hiSkill",  label: "하이스킬", type: "multi", options: ["메뉴얼팩", "오토백", "집품", "워터"], width: "150px" },
    { key: "special",  label: "특수",     type: "multi", options: ["AGV", "워터", "메뉴얼 멀티", "오토백 멀티"], width: "182px" },
    { key: "note",     label: "비고",     type: "text", width: "200px" },
  ],
  cd: [
    { key: "kucode",  label: "쿠코드", type: "text" },
    { key: "name",    label: "성함",   type: "text" },
...
export async function renderDataTab(root, ctx, params) {
  ...
  grid = createGrid({
    ...
    canDelete: isAdmin(),
    selectable: true,
    virtualize: true, // DATA 는 대용량(단기직 1,500+) — 가상 스크롤
